  ...
  return (
    <div className="flex flex-col gap-4 border-b pb-7 md:pb-10">
      <div className="flex justify-between md:gap-4">
        <div className="w-8 h-8 md:w-11 md:h-11 mr-4 bg-muted my-5 rotate-45 flex justify-center items-center rounded-md">
          <p className="text-xs md:text-base -rotate-45 ">{ayah.nomorAyat}</p>
        </div>
